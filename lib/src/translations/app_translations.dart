...
class AppTranslations {
  ...
  static const button_dismiss = TranslationEntry(
    key: 'button_dismiss',
    value: 'Dismiss',
  );
  ...
  static const error_invalid_email_address = TranslationEntry(
    key: 'error_invalid_email_address',
    value: 'Invalid email address',
  );

  static const error_login = TranslationEntry(
    key: 'error_login',
    value: 'Unable to login',
  );

  static const error_message_form = TranslationEntry(
    key: 'error_message_form',
    value: 'Please address form errors',
  );

  static const error_value_min_length = TranslationEntry(
    key: 'error_value_min_length',
    value: '{label} must be at least {length} characters',
  );

  static const error_value_required = TranslationEntry(
    key: 'error_value_required',
  ...
  static const label_first_name = TranslationEntry(
  ...
  static const login_create_account_button = TranslationEntry(
    key: 'login_create_account_button',
